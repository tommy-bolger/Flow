<?php
/**
* Allows the rendering of a <span> tag and its child elements dynamically.
...
extends Element {
    /**
     * Initializes a new instance of Span.
     *
     * @param string $element_text (optional) The display text inside of the span.     
